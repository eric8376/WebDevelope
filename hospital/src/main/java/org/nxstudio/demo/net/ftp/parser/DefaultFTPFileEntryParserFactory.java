 ...
 */
package org.nxstudio.demo.net.ftp.parser;

import org.nxstudio.demo.net.ftp.Configurable;
import org.nxstudio.demo.net.ftp.FTPClientConfig;
import org.nxstudio.demo.net.ftp.FTPFileEntryParser;
...
public class DefaultFTPFileEntryParserFactory
     ...
     *            following keywords:
     *            <ul>
     *            <li>{@link org.nxstudio.demo.net.ftp.FTPClientConfig#SYST_UNIX UNIX}</li>
     *            <li>{@link org.nxstudio.demo.net.ftp.FTPClientConfig#SYST_NT WINDOWS}</li>
     *            <li>{@link org.nxstudio.demo.net.ftp.FTPClientConfig#SYST_OS2 OS/2}</li>
     *            <li>{@link org.nxstudio.demo.net.ftp.FTPClientConfig#SYST_OS400 OS/400}</li>
     *            <li>{@link org.nxstudio.demo.net.ftp.FTPClientConfig#SYST_VMS VMS}</li>
     *            <li>{@link org.nxstudio.demo.net.ftp.FTPClientConfig#SYST_MVS MVS}</li>
     *            </ul>
     ...
     * @see org.nxstudio.demo.net.ftp.FTPFileEntryParser
     */
     ...
     * {@link  org.nxstudio.demo.net.ftp.FTPClientConfig FTPClientConfig}
     ...
     * </p>
     *
     * @param config A {@link  org.nxstudio.demo.net.ftp.FTPClientConfig FTPClientConfig}
