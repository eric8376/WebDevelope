/**
 * @class Ext4.Com.Other.calendar.src.template.Month
 * @extends Ext.XTemplate
 * <p>This is the template used to render the {@link Ext4.Com.Other.calendar.src.template.Month MonthView}. Internally this class defers to an
 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.template.Month', {
    ...
    constructor: function (config) {
        ...
        this.weekTpl = new Ext4.Com.Other.calendar.src.template.BoxLayout(config);
    ...
    applyTemplate: function (o) {
        var days = [],
            ...
            dt = o.viewStart,
            D = Ext4.Com.Other.calendar.src.util.Date;
