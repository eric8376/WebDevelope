...
function doOnLoad() {
	...
	var obj1 = new Object();
	obj1.sql = "select dict_id as 'key',dict_text as 'value' from t_per_ks";
	...
	var serviceCall = new ServiceCall();
	var obj2 = new Object();
	obj2.sql = "select dict_id as 'key',dict_text as 'value' from t_per_xm";
	serviceCall.init("queryDataSvc");
    ...
    var obj3=new Object();
    var roleId=getParam('roleId');
    obj3.sql="select t1.ksxm_id,ks_id,xm_id,if(t2.role_id is null,0,1),if(t2.role_id is null,0,1) as init_value from t_per_xm_ks  t1 left join t_per_role_xm  t2 on t1.ksxm_id=t2.ksxm_id and role_id='"+roleId+"'";
	serviceCall.init("queryDataSvc");
