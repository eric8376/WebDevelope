...
<script language="javascript" src="<%=request.getContextPath()%>/js/performance/hospital/recordAnalysis2.js"></script>
...
<body>
<div id="form_container" style="width:1000px;height:400px;align:center;" align="center"></div>
