...
if (parseInt(Ext.versions.extjs.version.substr(0, 1), 10) > 2) {
    ...
    Ext.define('Ext.menu.DateTimeItem',{
        extend:'Ext.menu.DateMenu',
...
Ext.define('Ext.menu.DateTimeMenu',{
