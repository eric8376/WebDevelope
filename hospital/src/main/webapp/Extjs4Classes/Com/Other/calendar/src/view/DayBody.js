/**S
 * @class Ext4.Com.Other.calendar.src.view.DayBody
 * @extends Ext4.Com.Other.calendar.src.view.AbstractCalendar
 ...
 * which aggregates this class and the {@link Ext4.Com.Other.calendar.src.DayHeaderView DayHeaderView} into the single unified view
 * presented by {@link Ext4.Com.Other.calendar.src.CalendarPanel CalendarPanel}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('Ext4.Com.Other.calendar.src.view.DayBody', {
    extend: 'Ext4.Com.Other.calendar.src.view.AbstractCalendar',
    alias: 'widget.daybodyview',

    requires: [
        'Ext.XTemplate',
        'Ext4.Com.Other.calendar.src.template.DayBody',
        'Ext4.Com.Other.calendar.src.data.EventMappings',
        'Ext4.Com.Other.calendar.src.dd.DayDragZone',
        'Ext4.Com.Other.calendar.src.dd.DayDropZone'
    ],
    ...
    initComponent: function () {
        ...
        this.addEvents({
             ...
             * @param {Ext4.Com.Other.calendar.src.view.DayBody} this
    ...
    initDD: function () {
        ...
        this.dragZone = new Ext4.Com.Other.calendar.src.dd.DayDragZone(this.el, Ext.apply({
                view: this,
                containerScroll: true
            },
            cfg));

        this.dropZone = new Ext4.Com.Other.calendar.src.dd.DayDropZone(this.el, Ext.apply({
                view: this
            },
            cfg));
    },
    ...
    afterRender: function () {
        if (!this.tpl) {
            this.tpl = new Ext4.Com.Other.calendar.src.template.DayBody({
                id: this.id,
    ...
    onEventResize: function (rec, data) {
        var D = Ext4.Com.Other.calendar.src.util.Date,
            start = Ext4.Com.Other.calendar.src.data.EventMappings.StartDate.name,
            end = Ext4.Com.Other.calendar.src.data.EventMappings.EndDate.name;
     ...
     * {@link Ext4.Com.Other.calendar.src.EventRecord}) to populate the calendar views with <strong>all-day</strong> events.
    ...
    getTemplateEventData: function (evt) {
        var selector = this.getEventSelectorCls(evt[Ext4.Com.Other.calendar.src.data.EventMappings.EventId.name]),
            data = {},
    ...
    getTemplateEventBox: function (evt) {
        var heightFactor = 0.7,
            start = evt[Ext4.Com.Other.calendar.src.data.EventMappings.StartDate.name],
            end = evt[Ext4.Com.Other.calendar.src.data.EventMappings.EndDate.name],
        ...
        for (; day < this.dayCount; day++) {
            ...
            for (; ev < ct; ev++) {
                ...
                evts.push({
                    ...
                    date: Ext4.Com.Other.calendar.src.util.Date.add(this.viewStart, {days: day})
                });
            }
        }
    ...
    getDayAt: function (x, y) {
        ...
        // 30 minute increment since a row is 60 minutes
            ...
            mins = rowIndex * 30,
            dt = Ext4.Com.Other.calendar.src.util.Date.add(this.viewStart, {days: dayIndex, minutes: mins}),
            el = this.getDayEl(dt),
            timeX = x;
    ...
    onClick: function (e, t) {
        if (this.dragPending || Ext4.Com.Other.calendar.src.view.DayBody.superclass.onClick.apply(this, arguments)) {
