...
<eRedG4:html title="查询历史检查记录">
    <eRedG4:ext.codeStore
            fields="SEX,LOCKED,USERTYPE:3,CS001,CS002,COM001,RT001,RGT001,COM002,COM002,OT001,LitigantRole,CheckNorm,CheckType"/>
    ...
    <eRedG4:import src="/CheckInfoManage/js/HistoryCheckDetailInfo.js"/>
    <eRedG4:body>
