Ext.define('Ext4.Com.Other.calendar.src.data.ProductRuleEvents', {

    statics: {
        getData: function (productid, cur_year, cur_month, lastInMonth, backfun) {
            ...
            var o;
            Ext.Ajax.request({
                url: './ProduceAction.ered?reqCode=checkProductUseRule',
                async: false,//默认为false
                params: {
                    productid: productid,
                    justyear: cur_year,
                    cur_month: cur_month,
                    lastInMonth: lastInMonth,
                    priority: '3,4',
