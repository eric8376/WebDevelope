...
(function(p) {
  ...
  s = [function(b) {
    ...
    else if (j.eqs(b.type, "click")) if (j.eqs(a.tagName, "span") && a.getAttribute("treeNode" + e.id.SWITCH) !== null) d = j.getNodeMainDom(a).id,
    g = "switchNode";
    else {
      if (k = j.getMDom(c, a, [{
        tagName: "a",
  ...
  h = {
    ...
    addNodesData: function(b, a, c) {
      ...
      a[d] || (a[d] = []);
      if (a[d].length > 0) a[d][a[d].length - 1].isLastNode = !1,
    ...
    getAfterA: function(b, a, c) {
      for (var d = 0,
      f = C.length; d < f; d++) C[d].apply(this, arguments)
    },
    getBeforeA: function(b, a, c) {
      for (var d = 0,
      f = B.length; d < f; d++) B[d].apply(this, arguments)
    },
    getInnerAfterA: function(b, a, c) {
      for (var d = 0,
      f = E.length; d < f; d++) E[d].apply(this, arguments)
    },
    getInnerBeforeA: function(b, a, c) {
      for (var d = 0,
      f = D.length; d < f; d++) D[d].apply(this, arguments)
    },
    getCache: function(b) {
      return v[b.treeId]
    },
    getNextNode: function(b, a) {
      ...
      d = a.parentTId ? a.getParentNode() : h.getRoot(b), f = 0, g = d[c].length - 1; f <= g; f++) if (d[c][f] === a) return f == g ? null: d[c][f + 1];
      return null
    },
    getNodeByParam: function(b, a, c, d) {
      if (!a || !c) return null;
      for (var f = b.data.key.children,
      g = 0,
      l = a.length; g < l; g++) {
    ...
    getNodesByParam: function(b, a, c, d) {
      if (!a || !c) return [];
      for (var f = b.data.key.children,
      g = [], l = 0, e = a.length; l < e; l++) a[l][c] == d && g.push(a[l]),
    ...
    getNodesByParamFuzzy: function(b, a, c, d) {
      if (!a || !c) return [];
      for (var f = b.data.key.children,
      g = [], d = d.toLowerCase(), l = 0, e = a.length; l < e; l++) typeof a[l][c] == "string" && a[l][c].toLowerCase().indexOf(d) > -1 && g.push(a[l]),
    ...
    getPreNode: function(b, a) {
      if (!a) return null;
      for (var c = b.data.key.children,
      d = a.parentTId ? a.getParentNode() : h.getRoot(b), f = 0, g = d[c].length; f < g; f++) if (d[c][f] === a) return f == 0 ? null: d[c][f - 1];
      return null
    },
    getRoot: function(b) {
    ...
    initNode: function(b, a, c, d, f, g) {
      for (var e = 0,
      h = z.length; e < h; e++) z[e].apply(this, arguments)
    },
    initRoot: function(b) {
      for (var a = 0,
      c = A.length; a < c; a++) A[a].apply(this, arguments)
    },
    ...
    removeNodeCache: function(b, a) {
      ...
      if (a[c]) for (var d = 0,
      f = a[c].length; d < f; d++) arguments.callee(b, a[c][d]);
      h.getCache(b).nodes[h.getNodeCacheId(a.tId)] = null
    },
    removeSelectedNode: function(b, a) {
      for (var c = h.getRoot(b), d = 0, f = c.curSelectedList.length; d < f; d++) if (a === c.curSelectedList[d] || !h.getNodeCache(b, c.curSelectedList[d].tId)) c.curSelectedList.splice(d, 1),
      d--,
      f--
    },
    ...
    setZTreeTools: function(b, a) {
      for (var c = 0,
      d = F.length; c < d; c++) F[c].apply(this, arguments)
    },
    transformToArrayFormat: function(b, a) {
      if (!a) return [];
      var c = b.data.key.children,
      d = [];
      if (j.isArray(a)) for (var f = 0,
      g = a.length; f < g; f++) d.push(a[f]),
  ...
  var j = {
    ...
    getMDom: function(b, a, c) {
      ...
      for (; a && a.id !== b.treeId;) {
        for (var d = 0,
        f = c.length; a.tagName && d < f; d++) if (j.eqs(a.tagName, c[d].tagName) && a.getAttribute(c[d].attrName) !== null) return a;
        a = a.parentNode
      }
      return null
    },
  ...
  i = {
    addNodes: function(b, a, c, d) {
      if (!b.data.keep.leaf || !a || a.isParent) if (j.isArray(c) || (c = [c]), b.data.simpleData.enable && (c = h.transformTozTreeFormat(b, c)), a) {
        ...
        g = k(a, e.id.ICON, b),
        l = k(a, e.id.UL, b);
        if (!a.open) i.replaceSwitchClass(a, f, e.folder.CLOSE),
      ...
      } else h.addNodesData(b, h.getRoot(b), c),
    ...
    expandCollapseNode: function(b, a, c, d, f) {
      ...
      if (a) {
        ...
        if (!a.open && a.isParent && (!k(a, e.id.UL, b).get(0) || a[l] && a[l].length > 0 && !k(a[l][0], b).get(0))) i.appendParentULDom(b, a),
        i.createNodeCallback(b);
    ...
    expandCollapseSonNode: function(b, a, c, d, f) {
      ...
      if (g) for (var k = 0,
      m = g.length; k < m; k++) g[k] && i.expandCollapseSonNode(b, g[k], c, e);
    ...
    removeChildNodes: function(b, a) {
      if (a) {
        ...
        if (d) {
          for (var f = 0,
          g = d.length; f < g; f++) h.removeNodeCache(b, d[f]);
    ...
    removeNode: function(b, a) {
      ...
      if (h.getNodeCache(b, a.tId)) {
        ...
        h.removeSelectedNode(b, a);
        for (var g = 0,
        l = f[d].length; g < l; g++) if (f[d][g].tId == a.tId) {
          f[d].splice(g, 1);
          break
        }
        i.setFirstNode(b, f);
        i.setLastNode(b, f);
        var j, g = f[d].length;
        if (!b.data.keep.parent && g == 0) f.isParent = !1,
        f.open = !1,
        g = k(f, e.id.UL, b),
        l = k(f, e.id.SWITCH, b),
        j = k(f, e.id.ICON, b),
    ...
    init: function(b, a, c) {
      ...
      c = {
        ...
        expandNode: function(a, b, c, e, n) {
          ...
          if (!j.canAsync(d, a) && c) i.expandCollapseSonNode(d, a, b, !0,
          function() {
            if (e !== !1) try {
              k(a, d).focus().blur()
            } catch(b) {}
        ...
        getNodeIndex: function(a) {
          ...
          c = a.parentTId ? a.getParentNode() : h.getRoot(d), e = 0, i = c[b].length; e < i; e++) if (c[b][e] == a) return e;
          return - 1
        },
        ...
        reAsyncChildNodes: function(a, b, c) {
          if (this.setting.async.enable) {
            ...
            if (b == "refresh") {
              ...
              m = 0,
              p = a[b] ? a[b].length: 0; m < p; m++) h.removeNodeCache(d, a[b][m]);
        ...
        selectNode: function(a, b) {
          if (a && j.uCanDo(d)) {
            ...
            if (a.parentTId) i.expandCollapseParentNode(d, a.getParentNode(), !0, !1,
            function() {
              try {
                k(a, d).focus().blur()
              } catch(b) {}
...
(function(m) {
  ...
  m.extend(!0, m.fn.zTree._z, {
    ...
    view: {
      checkNodeRelation: function(b, a) {
        ...
        if (b.check.chkStyle == c.STYLE) {
          ...
          if (a[l]) if (b.check.radioType == c.TYPE_ALL) {
            for (d = g.length - 1; d >= 0; d--) c = g[d],
            c[l] = !1,
            g.splice(d, 1),
            e.setChkClass(b, n(c, j.id.CHECK, b), c),
            c.parentTId != a.parentTId && e.repairParentChkClassWithSelf(b, c);
            g.push(a)
          } else {
            g = a.parentTId ? a.getParentNode() : f.getRoot(b);
            for (d = 0, h = g[i].length; d < h; d++) c = g[i][d],
            c[l] && c != a && (c[l] = !1, e.setChkClass(b, n(c, j.id.CHECK, b), c))
          } else if (b.check.radioType == c.TYPE_ALL) for (d = 0, h = g.length; d < h; d++) if (a == g[d]) {
            g.splice(d, 1);
            break
          }
        } else a[l] && (!a[i] || a[i].length == 0 || b.check.chkboxType.Y.indexOf("s") > -1) && e.setSonNodeCheckBox(b, a, !0),
        !a[l] && (!a[i] || a[i].length == 0 || b.check.chkboxType.N.indexOf("s") > -1) && e.setSonNodeCheckBox(b, a, !1),
        a[l] && b.check.chkboxType.Y.indexOf("p") > -1 && e.setParentNodeCheckBox(b, a, !0),
        !a[l] && b.check.chkboxType.N.indexOf("p") > -1 && e.setParentNodeCheckBox(b, a, !1)
      },
      ...
      repairAllChk: function(b, a) {
        if (b.check.enable && b.check.chkStyle === j.checkbox.STYLE) for (var c = b.data.key.checked,
        d = b.data.key.children,
        h = f.getRoot(b), i = 0, l = h[d].length; i < l; i++) {
          var g = h[d][i];
      ...
      repairSonChkDisabled: function(b, a, c, d) {
        if (a) {
          ...
          l = a[h].length; i < l; i++) e.repairSonChkDisabled(b, a[h][i], c, d)
        }
      },
      ...
      setSonNodeCheckBox: function(b, a, c, d) {
        if (a) {
          ...
          var g = !1;
          if (a[h]) for (var k = 0,
          m = a[h].length; k < m && a.chkDisabled !== !0; k++) {
            var o = a[h][k];
    ...
    data: {
      ...
      getTreeCheckedNodes: function(b, a, c, d) {
        if (!a) return [];
        for (var h = b.data.key.children,
        i = b.data.key.checked,
        e = c && b.check.chkStyle == j.radio.STYLE && b.check.radioType == j.radio.TYPE_ALL,
      ...
      getTreeChangeCheckedNodes: function(b, a, c) {
        if (!a) return [];
        for (var d = b.data.key.children,
        h = b.data.key.checked,
        c = !c ? [] : c, i = 0, e = a.length; i < e; i++) a[i].nocheck !== !0 && a[i].chkDisabled !== !0 && a[i][h] != a[i].checkedOld && c.push(a[i]),
  ...
  f.addInitProxy(function(b) {
    ...
    if (k.eqs(b.type, "mouseover")) {
      if (c.check.enable && k.eqs(a.tagName, "span") && a.getAttribute("treeNode" + j.id.CHECK) !== null) d = k.getNodeMainDom(a).id,
      e = "mouseoverCheck"
    } else if (k.eqs(b.type, "mouseout")) {
      if (c.check.enable && k.eqs(a.tagName, "span") && a.getAttribute("treeNode" + j.id.CHECK) !== null) d = k.getNodeMainDom(a).id,
      e = "mouseoutCheck"
    } else if (k.eqs(b.type, "click") && c.check.enable && k.eqs(a.tagName, "span") && a.getAttribute("treeNode" + j.id.CHECK) !== null) d = k.getNodeMainDom(a).id,
    e = "checkNode";
  ...
  f.addZTreeTools(function(b, a) {
    a.checkNode = function(a, c, i, f) {
      ...
      if (a.chkDisabled !== !0 && (c !== !0 && c !== !1 && (c = !a[g]), f = !!f, (a[g] !== c || i) && !(f && k.apply(this.setting.callback.beforeCheck, [b.treeId, a], !0) == !1) && k.uCanDo(this.setting) && b.check.enable && a.nocheck !== !0)) a[g] = c,
      c = n(a, j.id.CHECK, b),
      (i || b.check.chkStyle === j.radio.STYLE) && e.checkNodeRelation(b, a),
      e.setChkClass(b, c, a),
      e.repairParentChkClassWithSelf(b, a),
      f && b.treeObj.trigger(j.event.CHECK, [null, b.treeId, a])
    };
    ...
    a.updateNode = function(d, f) {
      ...
      if (d && b.check.enable && n(d, b).get(0) && k.uCanDo(b)) {
        var i = n(d, j.id.CHECK, b); (f == !0 || b.check.chkStyle === j.radio.STYLE) && e.checkNodeRelation(b, d);
        e.setChkClass(b, i, d);
  ...
  x = {
    ...
    onMousedownNode: function(b, a) {
      function c(b) {
        ...
        if (A.dragFlag == 0) {
          if (h.apply(e.callback.beforeDrag, [e.treeId, l], !0) == !1) return n(b),
          !0;
        ...
        if (A.dragFlag == 1) {
          ...
          i = e;
          g = m.getSettings();
          for (var D in g) if (g[D].treeId && g[D].edit.enable && g[D].treeId != e.treeId && (b.target.id == g[D].treeId || u(b.target).parents("#" + g[D].treeId).length > 0)) I = !0,
          i = g[D];
          D = E.scrollTop();
          j = E.scrollLeft();
          k = i.treeObj.offset();
          ...
          if (b.target.id && i.treeObj.find("#" + b.target.id).length > 0) {
            ...
            if (R && b.target.id && (b.target.id == B.id + d.id.A || u(b.target).parents("#" + B.id + d.id.A).length > 0)) r = u(B),
            v = B.id
          }
          g = l[0];
          ...
          if (r && r.attr("id") != i.treeId) {
            ...
            if (!g && !a && !F) {
              ...
              b = (b.clientY + D - s) / c.height(); (J == 1 || b <= J && b >= -0.2) && g ? (a = 1 - z.width(), k = s - z.height() / 2, w = d.move.TYPE_PREV) : (F == 0 || b >= F && b <= 1.2) && a ? (a = 1 - z.width(), k = k == null || y.isParent && y.open ? s + c.height() - z.height() / 2 : k.offset().top - z.height() / 2, w = d.move.TYPE_NEXT) : (a = 5 - z.width(), k = s, w = d.move.TYPE_INNER);
              z.css({
                display: "block",
                top: k + "px",
                left: j + a + "px"
      ...
      function n(b) {
        ...
        if (A.dragFlag != 0) {
          A.dragFlag = 0;
          var a, k, j;
          for (a = 0, k = l.length; a < k; a++) j = l[a],
          j.isParent && A.dragNodeShowBefore[j.tId] && !j.open && (f.expandCollapseNode(e, j, !j.open), delete A.dragNodeShowBefore[j.tId]);
          C && C.remove();
          z && z.remove();
          var p = b.ctrlKey && e.edit.drag.isMove && e.edit.drag.isCopy || !e.edit.drag.isMove && e.edit.drag.isCopy; ! p && r && v && l[0].parentTId && v == l[0].parentTId && w == d.move.TYPE_INNER && (r = null);
          if (r) {
    ...
    view: {
      ...
      moveNode: function(b, a, c, n, g, k) {
        ...
        if (a != c && (!b.data.keep.leaf || !a || a.isParent || n != d.move.TYPE_INNER)) {
          ...
          C = c.level;
          if (c.isFirstNode) {
            if (l = 0, h[e].length > 1) x = h[e][1],
            x.isFirstNode = !0
          } else if (c.isLastNode) l = h[e].length - 1,
          x = h[e][l - 1],
          x.isLastNode = !0;
          ...
          f.repairNodeLevelClass(b, c, C); ! b.data.keep.parent && h[e].length < 1 ? (h.isParent = !1, h.open = !1, a = o(h, d.id.UL, b), n = o(h, d.id.SWITCH, b), e = o(h, d.id.ICON, b), f.replaceSwitchClass(h, n, d.folder.DOCU), f.replaceIcoClass(h, e, d.folder.DOCU), a.css("display", "none")) : x && f.setNodeLineIcos(b, x);
    ...
    data: {
      setSonNodeLevel: function(b, a, c) {
        if (c) {
          ...
          if (c[d]) for (var a = 0,
          g = c[d].length; a < g; a++) c[d][a] && m.setSonNodeLevel(b, c, c[d][a])
        }
      }
    }
  });
