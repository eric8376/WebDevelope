 ...
 */
package org.nxstudio.demo.net.ftp;
...
import org.nxstudio.demo.net.io.SocketInputStream;
import org.nxstudio.demo.net.io.SocketOutputStream;
import org.nxstudio.demo.net.MalformedServerReplyException;
import org.nxstudio.demo.net.ftp.parser.DefaultFTPFileEntryParserFactory;
import org.nxstudio.demo.net.ftp.parser.FTPFileEntryParserFactory;
import org.nxstudio.demo.net.ftp.parser.ParserInitializationException;
import org.nxstudio.demo.net.io.CopyStreamEvent;
import org.nxstudio.demo.net.io.CopyStreamException;
import org.nxstudio.demo.net.io.FromNetASCIIInputStream;
import org.nxstudio.demo.net.io.ToNetASCIIOutputStream;
import org.nxstudio.demo.net.io.Util;
...
public class FTPClient extends FTP
     ...
     * @throws FTPConnectionClosedException If the FTP server prematurely closes the connection as a result
     ...
     *                                       from the server.
     * @throws ParserInitializationException Thrown if the parserKey parameter cannot be
     ...
     * @throws java.io.IOException           If an I/O error occurs while either sending a
     *                                       command to the server or receiving a reply from the server.
     * @throws ParserInitializationException Thrown if the autodetect mechanism cannot
