...
<div style="height: 580px; background: #bdd4e2;">
        <div style="background: url(<%=request.getContextPath()%>/images/performance/bureau/hospitalimg/bgt.jpg) 50% 50% no-repeat; height: 381px;
            margin: 0 auto;">
        </div>
        <div style="background: url(<%=request.getContextPath()%>/images/performance/bureau/hospitalimg/barm1.jpg)  repeat-x; height: 33px;">
        </div>
        <div style="background: url(<%=request.getContextPath()%>/images/performance/bureau/hospitalimg/bgb.jpg)  repeat-x; height: 166px;">
