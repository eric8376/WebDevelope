...
UploadPanel =Ext.define('UploadPanel',  {
    extend:'Ext.Panel',
	fileList : null,
	swfupload : null,
	progressBar : null,
				...
				render : {
					fn : function() {
						...
						var settings = {
							...
							//upload_url : 'http://127.0.0.1:8899/eRedG4/demo/test.ered?reqCode=doUpload',
		...
		switch (errorCode) {
            case 'uploadError':
               //自定义错误提示
                ...
                if (file.fileState != SWFUpload.FILE_STATUS.CANCELLED) {
                    record.set('fileState', SWFUpload.FILE_STATUS.CANCELLED);
                }
                    record.commit();
