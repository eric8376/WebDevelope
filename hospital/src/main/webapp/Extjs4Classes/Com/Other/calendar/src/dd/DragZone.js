 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.dd.DragZone', {
    extend: 'Ext.dd.DragZone',

    requires: [
        'Ext4.Com.Other.calendar.src.dd.StatusProxy',
    ...
    constructor: function (el, config) {
        if (!Ext4.Com.Other.calendar.src._statusProxyInstance) {
            Ext4.Com.Other.calendar.src._statusProxyInstance = new Ext4.Com.Other.calendar.src.dd.StatusProxy();
        }
        this.proxy = Ext4.Com.Other.calendar.src._statusProxyInstance;
    ...
    getDragData: function (e) {
        ...
        if (t) {
            ...
            return {
                type: 'eventdrag',
                ddel: t,
                eventStart: rec.data[Ext4.Com.Other.calendar.src.data.EventMappings.StartDate.name],
                eventEnd: rec.data[Ext4.Com.Other.calendar.src.data.EventMappings.EndDate.name],
                proxy: this.proxy
            };
        }
