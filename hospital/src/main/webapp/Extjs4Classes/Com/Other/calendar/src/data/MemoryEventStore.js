 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.data.MemoryEventStore', {
    extend: 'Ext.data.Store',
    model: 'Ext4.Com.Other.calendar.src.data.EventModel',
    ...
    constructor: function (config) {
        ...
        this.sorters = this.sorters || [{
            property: Ext4.Com.Other.calendar.src.data.EventMappings.StartDate.name,
            direction: 'ASC'
        }];

        this.idProperty = this.idProperty || Ext4.Com.Other.calendar.src.data.EventMappings.EventId.mapping || 'id';
        this.fields = Ext4.Com.Other.calendar.src.data.EventModel.prototype.fields.getRange();
    ...
    interceptCreateRecords: function (records, operation, success) {
        if (success) {
            ...
            for (; i < len; i++) {
                records[i].data[Ext4.Com.Other.calendar.src.data.EventMappings.EventId.name] = records[i].id;
            }
        }
    },
