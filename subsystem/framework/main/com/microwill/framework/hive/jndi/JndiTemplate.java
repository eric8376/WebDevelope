 ...
 * and bind objects, and allows implementations of the JndiCallback interface to
 * perform any operation they like with a JNDI naming context provided.
 * 
 * <p>
 * This is the central class in this package. It performs all JNDI context
 * handling.
 * 
 * @author Rod Johnson
...
public class JndiTemplate {
	...
	/**
	 * Create a new JNDI initial context. Invoked by execute. The default
	 * implementation use this template's environment settings. Can be
	 ...
	 * @return object found (cannot be <code>null</code>; if a not so
	 *         well-behaved JNDI implementations returns null, a NamingException
	 *         gets thrown)
	 * @throws NamingException
	 ...
	 *            superclass of the actual class, or <code>null</code> for any
	 *            match. For example, if the value is <code>Object.class</code>,
	 *            this method will succeed whatever the class of the returned
	 *            instance.
	 * @return object found (cannot be <code>null</code>; if a not so
	 *         well-behaved JNDI implementations returns null, a NamingException
	 *         gets thrown)
	 ...
	 *             if there is no object with the given name bound to JNDI
	 */
	public Object lookup(String name, Class requiredType)
			throws NamingException {
		Object jndiObject = lookup(name);
		if (requiredType != null && !requiredType.isInstance(jndiObject)) {
			throw new NamingException("Object [" + jndiObject
					+ "] available at JNDI location [" + name
	...
	/**
	 * Rebind the given object to the current JNDI context, using the given
	 * name. Overwrites any existing binding.
	 * 
	 * @param name
	 *            the JNDI name of the object
	 * @param object
