...
body
        ...
        #button
        {
            ...
            cursor: pointer;
            margin-top: 26px;
            background: url(images/performance/nursingimg/login1.jpg) 50% 50% no-repeat;
        }
        #button:hover
        {
            float: left;
            ...
            height: 28px;
            cursor: pointer;
            background: url(images/performance/nursingimg/login2.jpg) 50% 50% no-repeat;
        }
        input
        {
            width: 120px;
...
<div style="height: 580px; background: #bdd4e2;">
        <div style="background: url(images/performance/nursingimg/bgt.jpg) 50% 50% no-repeat; height: 381px;
            margin: 0 auto;">
        </div>
        <div style="background: url(images/performance/nursingimg/barm1.jpg)  repeat-x; height: 33px;">
        </div>
        <div style="background: url(images/performance/nursingimg/bgb.jpg)  repeat-x; height: 166px;">
            ...
            <div style="background: url(images/performance/nursingimg/bgb2.jpg) 50% 50% no-repeat; height: 50px;
                padding-top: 25px;">
            </div>
        </div>
    </div>
