...
dhtmlxEvent(window,"load", doOnLoad);
		function doOnLoad() {
			 operation=getParam('operation');
		        ...
		        if(operation=="update"){
		        	 ...
		        	 var serviceCall = new ServiceCall();
						...
						myForm.setItemValue("userName", result.list[0].user_name);
						myForm.setItemValue("realName", result.list[0].real_name);
		 ...
		 function loadKSByType(isInit){
			    ...
			    obj.sql="select DICT_ID as value,DICT_TEXT as text from nursing.t_dict_table  where group_code='"+ks_type+"'"+filterCondition;
