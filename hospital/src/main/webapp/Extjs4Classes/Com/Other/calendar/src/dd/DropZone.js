 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.dd.DropZone', {
        ...
        if (n && data) {
            if (data.type == 'eventdrag') {
                var rec = this.view.getEventRecordFromEl(data.ddel),
                    dt = Ext4.Com.Other.calendar.src.util.Date.copyTime(rec.data[Ext4.Com.Other.calendar.src.data.EventMappings.StartDate.name], n.date);
