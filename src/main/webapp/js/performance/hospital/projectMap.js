...
function doOnLoad() {
    ...
    var obj=new Object();
    var projectId=getParam('projectId');
    obj.sql="select dict_id,dict_text,if(t2.ks_id is null,0,1),if(t2.ks_id is null,0,1) as init_value from t_per_bm  t1 left join t_per_xm_ks  t2 on t1.dict_id=t2.ks_id and xm_id='"+projectId+"'";
