 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.dd.DayDropZone', {
    extend: 'Ext4.Com.Other.calendar.src.dd.DropZone',
    requires: [
    ...
    onNodeOver: function (n, dd, e, data) {
        ...
        if (data.type == 'caldrag') {
            ...
            curr = Ext4.Com.Other.calendar.src.util.Date.copyTime(n.date, this.dragCreateDt);
            this.dragStartDate = Ext4.Com.Other.calendar.src.util.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || Ext4.Com.Other.calendar.src.util.Date.max(this.dragCreateDt, curr);
            ...
            if (data.type == 'eventresize') {
                ...
                curr = Ext4.Com.Other.calendar.src.util.Date.copyTime(n.date, this.resizeDt);
                start = Ext4.Com.Other.calendar.src.util.Date.min(data.eventStart, curr);
                end = Ext4.Com.Other.calendar.src.util.Date.max(data.eventStart, curr);
