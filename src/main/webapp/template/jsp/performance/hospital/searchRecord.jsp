...
<script language="javascript" src="<%=request.getContextPath()%>/js/performance/hospital/searchRecord.js"></script>
...
<body>
	<div id="form_container" style="width:800px;" align="center"></div>
