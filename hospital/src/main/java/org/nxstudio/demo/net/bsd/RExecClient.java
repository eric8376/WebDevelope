 ...
 */
package org.nxstudio.demo.net.bsd;
...
public class RExecClient extends SocketClient {
     ...
     *                            False if not.
     * @throws java.io.IOException If the rexec() attempt fails.  The exception
     ...
     * <p/>
     *
     * @throws java.io.IOException If there an error occurs while disconnecting.
     *                             *
     */
