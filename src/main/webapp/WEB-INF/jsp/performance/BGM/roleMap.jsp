...
<script language="javascript" src="<%=request.getContextPath()%>/js/performance/hospital/roleMap.js"></script>
...
<input type="button" value='返回' onclick="parent.loadPage('manage.spr?action=roleManage');"/>
<body>
