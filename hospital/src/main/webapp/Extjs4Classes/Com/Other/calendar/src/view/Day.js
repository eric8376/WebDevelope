/**
 * @class Ext4.Com.Other.calendar.src.view.Day
 * @extends Ext.container.Container
 * <p>Unlike other calendar views, is not actually a subclass of {@link Ext4.Com.Other.calendar.src.view.AbstractCalendar AbstractCalendar}.
 * Instead it is a {@link Ext.container.Container Container} subclass that internally creates and manages the layouts of
 * a {@link Ext4.Com.Other.calendar.src.DayHeaderView DayHeaderView} and a {@link Ext4.Com.Other.calendar.src.DayBodyView DayBodyView}. As such
 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.view.Day', {
    extend: 'Ext.container.Container',
    alias: 'widget.dayview',

    requires: [
        'Ext4.Com.Other.calendar.src.view.AbstractCalendar',
        'Ext4.Com.Other.calendar.src.view.DayHeader',
        'Ext4.Com.Other.calendar.src.view.DayBody'
    ],
    ...
    setStore: function (store) {
        this.header.store = store;
        this.body.store = store;
    }
});
