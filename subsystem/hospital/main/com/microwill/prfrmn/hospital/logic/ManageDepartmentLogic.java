...
public class ManageDepartmentLogic extends UserTypeLogic {
	...
	public String getKSList() throws Exception {
		...
		List list=getQueryDataCmd().getJdbcTemplate().queryForList(KSSql,hosp_id);
	...
	public String getXMList() throws Exception {
		...
		String hosp_id=(String)getLoginedUserContext().get("hosp_id");
		List list=getQueryDataCmd().getJdbcTemplate().queryForList(XMSql,new Object[]{ks,hosp_id});
		String jsonTxt=JSONExecuteHelp.parseJSONText(list);
		return jsonTxt;
	}
	...
	public String getScopeSql() {
		...
		String hosp_id=(String)getLoginedUserContext().get("hosp_id");
		List<Map<String,Object>> kslist=getQueryDataCmd().getJdbcTemplate().queryForList(KSSql,hosp_id);
		List<Map<String,Object>> xmlist=getQueryDataCmd().getJdbcTemplate().queryForList(XMSql,new Object[]{ks_id,hosp_id});
