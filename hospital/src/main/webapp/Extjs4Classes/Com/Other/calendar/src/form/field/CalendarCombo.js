/**
 * @class Ext4.Com.Other.calendar.src.form.field.CalendarCombo
 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.form.field.CalendarCombo', {
...
//    selectOnFocus: true,
    ...
    initComponent: function () {
        this.valueField = Ext4.Com.Other.calendar.src.data.CalendarMappings.CalendarId.name;
        this.displayField = Ext4.Com.Other.calendar.src.data.CalendarMappings.Title.name;
    ...
    getListItemTpl: function (displayField) {
        return '<div class="x-combo-list-item ext-color-{' + Ext4.Com.Other.calendar.src.data.CalendarMappings.CalendarId.name +
    ...
    getStyleClass: function (value) {
        ...
        if (!Ext.isEmpty(val)) {
            ...
            return 'ext-color-' + (val.data ? val.data[Ext4.Com.Other.calendar.src.data.CalendarMappings.CalendarId.name] : val);
        }
        return '';
    },
    ...
    setValue: function (value) {
        if (!value && this.store.getCount() > 0) {
            ...
            value = this.store.getAt(0).data[Ext4.Com.Other.calendar.src.data.CalendarMappings.CalendarId.name];
        }
