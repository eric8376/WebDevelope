/**
 * @class Ext4.Com.Other.calendar.src.form.EventDetails
 ...
 * calendar components. It is also configured to automatically bind records of type {@link Ext4.Com.Other.calendar.src.EventRecord}
 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.form.EventDetails', {
    extend: 'Ext.form.Panel',
    alias: 'widget.eventeditform',

    requires: [
        'Ext4.Com.Other.calendar.src.form.field.DateRange',
        'Ext4.Com.Other.calendar.src.form.field.ReminderCombo',
        'Ext4.Com.Other.calendar.src.data.EventMappings',
        'Ext4.Com.Other.calendar.src.form.field.CalendarCombo'
    ],
    ...
    initComponent: function () {
        ...
        this.addEvents({
             ...
             * @param {Ext4.Com.Other.calendar.src.form.EventDetails} this
        ...
        this.dateRangeField = new Ext4.Com.Other.calendar.src.form.field.DateRange({
            fieldLabel: 'When',
            singleLine: false,
            anchor: '90%'
        });
        this.reminderField = new Ext4.Com.Other.calendar.src.form.field.ReminderCombo({
            name: 'Reminder',
            anchor: '70%'
        });
        this.notesField = new Ext.form.TextArea({
            fieldLabel: 'Notes',
            name: Ext4.Com.Other.calendar.src.data.EventMappings.Notes.name,
            grow: true,
            growMax: 150,
            anchor: '100%'
        });
        this.locationField = new Ext.form.Text({
            fieldLabel: 'Location',
            name: Ext4.Com.Other.calendar.src.data.EventMappings.Location.name,
            anchor: '100%'
        });
        this.urlField = new Ext.form.Text({
            fieldLabel: 'Web Link',
            name: Ext4.Com.Other.calendar.src.data.EventMappings.Url.name,
            anchor: '100%'
        });
        ...
        if (this.calendarStore) {
            this.calendarField = new Ext4.Com.Other.calendar.src.form.field.CalendarCombo({
    ...
    loadRecord: function (rec) {
        ...
        if (this.calendarStore) {
            this.form.setValues({
                'calendar': rec.data[Ext4.Com.Other.calendar.src.data.EventMappings.CalendarId.name]
            });
        }
