...
import org.nxstudio.util.xml.XmlHelper;
 ...
 *
 * @author XiongChun
 * @see org.nxstudio.core.model.Dto
...
public class BaseDto extends HashMap implements Dto, Serializable {
    ...
    /**
     * 以java.util.Date类型返回键值
     *
     * @param key 键名
     * @return java.util.Date 键值
     */
    public java.util.Date getAsDateTime(String key) {
        Object obj = TypeCaseHelper.convert(get(key), "java.util.Date", "yyyy-MM-dd HH:mm:ss");
        if (obj != null)
