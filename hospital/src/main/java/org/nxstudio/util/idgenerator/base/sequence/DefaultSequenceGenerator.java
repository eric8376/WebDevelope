...
import org.nxstudio.util.idgenerator.base.InitSequenceGeneratorException;
import org.nxstudio.util.idgenerator.base.SequenceGenerator;
import org.nxstudio.util.idgenerator.base.SequenceStorer;
import org.nxstudio.util.idgenerator.base.storer.FileSequenceStorer;
...
public class DefaultSequenceGenerator implements SequenceGenerator {
    ...
    public void init() {
        ...
        maxCount = Math.min(maxCount, maxValue);
