/**
 * @class Ext4.Com.Other.calendar.src.view.Month
 * @extends Ext4.Com.Other.calendar.src.CalendarView
 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.view.Month', {
    extend: 'Ext4.Com.Other.calendar.src.view.AbstractCalendar',
    alias: 'widget.monthview',

    requires: [
        'Ext.XTemplate',
        'Ext4.Com.Other.calendar.src.template.Month',
        'Ext4.Com.Other.calendar.src.util.WeekEventRenderer',
        'Ext4.Com.Other.calendar.src.view.MonthDayDetail'
    ],
     ...
     * True to display an extra column before the first day in the calendar that links to the {@link Ext4.Com.Other.calendar.src.WeekView view}
    ...
    initComponent: function () {
        ...
        this.addEvents({
             ...
             * @param {Ext4.Com.Other.calendar.src.view.Month} this
    ...
    initDD: function () {
        ...
        this.dragZone = new Ext4.Com.Other.calendar.src.dd.DragZone(this.el, cfg);
        this.dropZone = new Ext4.Com.Other.calendar.src.dd.DropZone(this.el, cfg);
    },
    ...
    afterRender: function () {
        if (!this.tpl) {
            this.tpl = new Ext4.Com.Other.calendar.src.template.Month({
                id: this.id,
    ...
    getTemplateEventData: function (evt) {
        ...
        return Ext.applyIf({
                ...
                Title: (evt[M.IsAllDay.name] ? '' : Ext.Date.format(evt[M.StartDate.name], 'g:ia ')) + (!title || title.length == 0 ? '' : title)
            },
            evt);
    },
    ...
    renderItems: function () {
        Ext4.Com.Other.calendar.src.util.WeekEventRenderer.render({
    ...
    getDayAt: function (x, y) {
        var box = this.el.getBox(),
            ...
            days = (dayT * 7) + dayL,
            dt = Ext4.Com.Other.calendar.src.util.Date.add(this.viewStart, {days: days});
        return {
            date: dt,
            el: this.getDayEl(dt)
        };
    ...
    onClick: function (e, t) {
        ...
        if (Ext4.Com.Other.calendar.src.view.Month.superclass.onClick.apply(this, arguments)) {
