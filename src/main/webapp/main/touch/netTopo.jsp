...
<body>
<ol id="grid">
	 <li><a id="icons" href="<%=request.getContextPath()%>/main/touch/testTrsSys.jsp" target="_blank">
        <img src="<%=request.getContextPath()%>/style/touch/images/wltp.png" alt="Icons" height="72" width="72" />
        <span>传输网拓扑图</span>
    </a></li>
    <li><a id="dkhst" href="<%=request.getContextPath()%>/main/touch/optAccessNew.jsp" target="_blank">
        <img src="<%=request.getContextPath()%>/style/touch/images/jrdtp.png" alt="Kitchen Sink" height="72" width="72" />
        <span>接入点拓扑图</span>
    </a></li>
</ol>
</body>
