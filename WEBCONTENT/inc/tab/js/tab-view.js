	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = _prefDir+'images/tab_right_inactive.gif';
		...
		img.src = _prefDir+'images/tab_right_active.gif';
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = _prefDir+'images/tab_right_over.gif';
		}
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab,fcts)
	{
		...
		if(!additionalTab || additionalTab=='undefined'){
			...
			if(height.length>0){
				...
				//   height = document.body.clientHeight*parseInt(height.replace("%",""),10)/100;
				//   height +="px";
		...
		for(var no=0;no<tabTitles.length;no++){
		    ...
		    showTab(this.parentNode.parentNode.id,tabIndex);
			if((typeof fcts != "undefined") && (typeof fcts == "object") && (fcts.constructor == Array)){
			...
			if(closeButtonArray[no]){
				...
				closeButton.src = _prefDir+'images/close.gif';
