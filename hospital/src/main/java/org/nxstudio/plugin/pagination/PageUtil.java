package org.nxstudio.plugin.pagination;

import org.nxstudio.util.KeySynchronizer;
...
public class PageUtil {
     ...
     * 构造适合Ext 的分页对象
     */
    public static <E> Page<E> getPage(int totalCount, List<E> items) {
        IPageContext<E> pageContext = new QuickPageContext<E>(totalCount, items);
        return pageContext.getPage(1);
    }
