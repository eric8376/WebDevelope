...
body
        ...
        #button
        {
            ...
            cursor: pointer;
            margin-top: 26px;
            background: url(<%=request.getContextPath()%>/images/performance/hospital/hospitalimg/login1.jpg) 50% 50% no-repeat;
        }
        #button:hover
        {
            float: left;
            ...
            height: 28px;
            cursor: pointer;
            background: url(<%=request.getContextPath()%>/images/performance/hospital/hospitalimg/login2.jpg) 50% 50% no-repeat;
        }
        input
        {
            width: 120px;
...
<div style="height: 580px; background: #bdd4e2;">
        <div style="background: url(<%=request.getContextPath()%>/images/performance/hospital/hospitalimg/bgt.jpg) 50% 50% no-repeat; height: 381px;
            margin: 0 auto;">
        </div>
        <div style="background: url(<%=request.getContextPath()%>/images/performance/hospital/hospitalimg/barm1.jpg)  repeat-x; height: 33px;">
        </div>
        <div style="background: url(<%=request.getContextPath()%>/images/performance/hospital/hospitalimg/bgb.jpg)  repeat-x; height: 166px;">
            ...
            <div style="background: url(<%=request.getContextPath()%>/images/performance/hospital/hospitalimg/bgb2.jpg) 50% 50% no-repeat; height: 50px;
                padding-top: 25px;">
            </div>
        </div>
    </div>
