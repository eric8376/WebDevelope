/**
 * @class Ext4.Com.Other.calendar.src.template.DayBody
 * @extends Ext.XTemplate
 * <p>This is the template used to render the scrolling body container used in {@link Ext4.Com.Other.calendar.src.DayView DayView} and
 * {@link Ext4.Com.Other.calendar.src.WeekView WeekView}. This template is automatically bound to the underlying event store by the
 ...
 * that internally creates an instance of this template along with a {@link Ext4.Com.Other.calendar.src.DayHeaderTemplate}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('Ext4.Com.Other.calendar.src.template.DayBody', {
    ...
    applyTemplate: function (o) {
        this.today = Ext4.Com.Other.calendar.src.util.Date.today();
        ...
        for (; i < this.dayCount; i++) {
            days[i] = Ext4.Com.Other.calendar.src.util.Date.add(dt, {days: i});
        }
        ...
        for (i = 0; i < 24; i++) {
            ...
            dt = Ext4.Com.Other.calendar.src.util.Date.add(dt, {hours: 1});
        }
