...
//		String sql = "select dict_id,dict_text from nursing.t_dict_table where group_code='ks' and hosp_id=? ";
...
//		String sql = "select dict_id,dict_text from nursing.t_dict_table where group_code='xm' and hosp_id=? ";
//		List list = getJdbcTemplate().queryForList(sql,getLoginedUserContext().get("hosp_id"));
//		String jsonTxt = JSONExecuteHelp.parseJSONText(list);
//		return jsonTxt;
//	}
