/**
 * @class Ext4.Com.Other.calendar.src.data.EventModel
 * @extends Ext.data.Record
 * <p>This is the {@link Ext.data.Record Record} specification for calendar event data used by the
 * {@link Ext4.Com.Other.calendar.src.CalendarPanel CalendarPanel}'s underlying store. It can be overridden as
 ...
 * <p>Here is a basic example for how to create a new record of this type:<pre><code>
 rec = new Ext4.Com.Other.calendar.src.data.EventModel({
 ...
 * If you have overridden any of the record's data mappings via the Ext4.Com.Other.calendar.src.data.EventMappings object
 ...
 */
Ext.define('Ext4.Com.Other.calendar.src.data.EventModel', {
        ...
        statics: {
            /**
             * Reconfigures the default record definition based on the current {@link Ext4.Com.Other.calendar.src.data.EventMappings EventMappings}
             * object. See the header documentation for {@link Ext4.Com.Other.calendar.src.data.EventMappings} for complete details and
    ...
    function () {
        Ext4.Com.Other.calendar.src.data.EventModel.reconfigure();
    });