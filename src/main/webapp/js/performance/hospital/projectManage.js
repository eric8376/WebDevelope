...
function doOnLoad() {
    ...
    obj.sql="select t1.dict_id,t1.dict_text,CONCAT('Delete^javascript:doDelete(\"',t1.dict_id,'\");^_self'),CONCAT('Manage^javascript:doManage(\"',t1.dict_id,'\");^_self') ,GROUP_CONCAT(t2.ks_text) as group_ks" +
