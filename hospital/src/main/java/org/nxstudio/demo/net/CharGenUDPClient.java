...
public final class CharGenUDPClient extends DatagramSocketClient {
     ...
     * @throws java.io.IOException If an error occurs while sending the datagram.
     *                             *
     */
     ...
     * @throws java.io.IOException If an error occurs while receiving the datagram.
     *                             *
     */
